...
fun LoginScreen(
    ...
    val launcher = loginViewModel.rememberFirebaseAuthLauncher(
    ...
    val email = remember {
        mutableStateOf("hello@example.com")
    }
    ...
    loginViewModel.checkUser(GlobalConstants.user,Screen.LOGIN_SCREEN)
    if(loginState.collectAsState().value.isLoginSuccessful){
